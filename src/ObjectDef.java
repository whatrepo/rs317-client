public final class ObjectDef {
	...
	public static ObjectDef forID(int i) {
		...
		case 26820:
		case 26821:
			class46.name = "Vote Booth";
			class46.actions = new String[5];
			class46.actions[0] = "Vote";
			class46.actions[1] = "Open store";
			class46.actions[2] = "Info(vote points)";
			class46.hasActions = true;
			break;
		...
		case 9371:
		case 6249:
			class46.name = "Player-Owned Shops";
			class46.actions = new String[5];
        ...
        case 18769:
        	class46.name = "Max cape rack";
        	class46.actions = new String[5];
        	class46.actions[0] = "Take-from";
        	break;
        ...
        case 27785:
        	...
        	break;
        case 27057:
        	class46.name = "Overseer";
        	class46.actions = new String[5];
        	class46.actions[0] = "Abyssal Dagger";
		class46.actions[1] = "Abyssal Bludgeon";
        	break;
        		
        case 27980:
        	class46.name = "Altar of bones";
        	class46.actions = new String[5];
...
//			System.out.println(Arrays.toString(childrenIDs));
	...
	public int anInt745;
	public int anInt746;
	public int[] originalModelColors,  textureReplace, textureFind;
	public int anInt748;
	public int anInt749;
