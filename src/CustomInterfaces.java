...
public class CustomInterfaces extends RSInterface {
	 ...
	 * @param Sythescape
	 */
	public static void unpackInterfaces(TextDrawingArea[] Sythescape) {
		 ...
		 */
		equipmentTab(Sythescape);
		equipmentScreen(Sythescape);

		/*
		 * Quick prayer & curses
		 */
		quickCurses(Sythescape);
		quickPrayers(Sythescape);

		/*
		 * Handles the tab to configure client settings
		 */
		optionTab(Sythescape);
		...
		/*
		 * Handles teleporting to various locations around Sythescape
		 */
		trainingTeleport(Sythescape);
		skillingTeleport(Sythescape);
		pvpTeleport(Sythescape);
		bossTeleport(Sythescape);
		minigameTeleport(Sythescape);
		otherTeleport(Sythescape);
		 ...
		 */
		warriorGuild(Sythescape);
		
		/*
		 * Handles displaying information on the Pest Control minigame
		 */
		pestControlBoat(Sythescape);
		pestControlGame(Sythescape);
		
		/*
		 * Handles Player Profiler interface
		 */
		playerProfiler(Sythescape);
		myProfile(Sythescape);
		//profileTab(Sythescape);
		profileLeaderboards(Sythescape);
		 ...
		 * Loyalty title
		 */
		loyaltyShop(Sythescape);
		
		/**
		 * Quest interface
		 */
		questInterface(Sythescape);
		
		/**
		 * Handles the fire colors
		 */
		fireColor(Sythescape);

		/*
		 * The clan chat interface & tab (Handles all the main functions of clan
		 * chat)
		 */
		clanChatTab(Sythescape);
		clanChatSetup(Sythescape);
		 ...
		 * Tab Creation
		 */
		tabCreation(Sythescape);
		
		/**
		 * Report Abuse
		 */
		reportAbuse(Sythescape);
		
		/**
		 * Bolt enchanting
		 */
		boltEnchanting(Sythescape);
		
		/**
		 * Weapon Game
		 */
		weaponLobby(Sythescape);
		weaponGame(Sythescape);
		weaponStore(Sythescape);
		
		/**
		 * Bank Pins Management
		 */
		bankPinManager(Sythescape);
		
		/**
		 * Account Manager
		 */
		accountManager(Sythescape);
	...
	public static void screenOptions(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(28200);
		addSprite(28201, 472);
		addText(28202, "Screen Options", sythescape, 2, 0xff9933, true, true);
		...
		addText(28209, "Transparent side panel", sythescape, 1, 0xff9933, false, true);
		addText(28210, "Make each side panel transparent", sythescape, 0, 0xff9933, false, true);
		addText(28211, "Transparent chatbox", sythescape, 1, 0xff9933, false, true);
		addText(28212, "Make chatbox transparent", sythescape, 0, 0xff9933, false, true);
		addText(28213, "Side-stones arrangement", sythescape, 1, 0xff9933, false, true);
		addText(28214, "Change the side-stones arrangement", sythescape, 0, 0xff9933, false, true);
		addText(28215, "Settings are not applicable in fixed mode!", sythescape, 0, 0xff9933, true, true);
	...
	public static void weaponStore(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(56500);
		addSprite(56501, 462);
		addText(56502, "Weapon Game Reward Store", sythescape, 2, 0xff9933, true, true);
		itemContainer(56503, 28, 8, 6, 50, false, "Select", "Buy");
		addText(56504, "Welcome to the Weapon Game Rewards store!", sythescape, 0, 0xff9933, true, true);
		addText(56505, "", sythescape, 0, 0xff9933, true, true);
		addText(56506, "", sythescape, 0, 0xff9933, false, true);
		addText(56507, "", sythescape, 0, 0xff9933, false, true);
		itemContainer(56508, 28, 8, 20, 50, false);
		addText(56509, "", sythescape, 0, 0xff9933, false, true);
	...
	public static void bankPin(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(48750);
		addSprite(48751, 461);
		addText(48752, "Bank Pin", sythescape, 2, 0xff9933, true, true);
		addText(48753, "You need to enter your bank pin", sythescape, 1, 0xff9933, true, true);
		addText(48754, "before accessing this!", sythescape, 1, 0xff9933, true, true);
		addInputField(48750, 48755, 4, 0x332E24, 0x4D4636, 0x383631, 0x474540, "", 150, 23, false, false, "");
		addHoverText(48756, "Close window", "Close window", sythescape, 1, 0xF7AA25, false, true, 250);
		tab.totalChildren(6);
	...
	public static void accountManager(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(56000);
		addSprite(56001, 460);
		addHoverButton(56002, 17, 21, 21, "Close", 250, 56003, 3);
		addHoveredButton(56003, 18, 21, 21, 56004);	
		addText(56005, "Account Security Management", sythescape, 2, 0xff9933, true, true);
		addText(56006, "Please answer the following prompts to ensure a safe account.", sythescape, 0, 0xff9933, true, true);
		addText(56007, "Having a safe account is crucial in the world of Sythescape.", sythescape, 0, 0xff9933, true, true);
		addText(56008, "Make sure to write all this information down!", sythescape, 0, 0xff9933, true, true);
		addText(56009, "Full Name", sythescape, 2, 0xff9933, true, true);
		addText(56010, "Email Address:", sythescape, 2, 0xff9933, true, true);
		addText(56011, "Recovery Answer:", sythescape, 2, 0xff9933, true, true);
		addText(56012, "IP Address:", sythescape, 2, 0xff9933, true, true);
		...
		addText(56017, "@red@Once you set your information it cannot be changed!", sythescape, 0, 0xff9933, true, true);
	...
	public static void ticketInterface(TextDrawingArea[] sythescape) {
		RSInterface boob = addInterface(51250);
		addSprite(51251, 463);
		addText(51252, "Ticket Manager", sythescape, 2, 0xff9933, true, true);
		...
		addText(51256, "Title:", sythescape, 3, 0xff9933, true, true);
		addText(51257, "Issue:", sythescape, 3, 0xff9933, true, true);
		...
		addText(51263, "Send", sythescape, 3, 0xff9933, true, true);
	...
	public static void bankPinManager(TextDrawingArea[] sythescape) {
		RSInterface boob = addInterface(43750);
		addSprite(43751, 459);
		addText(43752, "Bank Pin Management", sythescape, 2, 0xff9933, true, true);
		addText(43753, "</col>Bank pin status: @red@None!", sythescape, 0, 0xff9933, true, true);
		addText(43754, "Type in a 4 digit number and press enter to set a pin.", sythescape, 0, 0xff9933, true, true);
		addInputField(43750, 43755, 4, 0x332E24, 0x4D4636, 0x383631, 0x474540, "", 100, 23, false, false, "");
		addText(43756, "Be sure to write this down!", sythescape, 0, 0xff9933, true, true);
	...
	public static void weaponLobby(TextDrawingArea[] sythescape) {
		RSInterface boob = addInterface(41250);
		addSprite(41251, 453);
		addText(41252, "Players ready: 0", sythescape, 0, 0x33cc00, false, true);
		addText(41253, "(Need 5 to 20)", sythescape, 0, 0xFFcc33, false, true);
		addText(41254, "Next Departure: 60 sec", sythescape, 0, 0x33ccff, false, true);
	...
	public static void weaponGame(TextDrawingArea[] sythescape) {
		RSInterface boob = addInterface(41270);
		addTransparentSprite(41271, 452);
		addText(41272, "Weapon Game", sythescape, 2, 0xff9933, true, true);
		addText(41273, "Time Left:", sythescape, 0, 0xff9933, false, true);
		addText(41274, "5:30", sythescape, 0, 0xFFFFFF, false, true);
		addText(41275, "Players:", sythescape, 0, 0xff9933, false, true);
		addText(41276, "7", sythescape, 0, 0xFFFFFF, false, true);
		addText(41277, "Leader:", sythescape, 0, 0xff9933, false, true);
		addText(41278, "Daniel", sythescape, 0, 0xFFFFFF, false, true);
		addText(41279, "Crates:", sythescape, 0, 0xff9933, false, true);
		addText(41280, "0:14", sythescape, 0, 0xFFFFFF, false, true);
		addText(41281, "Tier:", sythescape, 0, 0xff9933, false, true);
		addText(41282, "5", sythescape, 0, 0xFFFFFF, false, true);
		itemContainer(41283, 45, 8, 20, 50, true);
		
		addText(41284, "Current", sythescape, 0, 0xff9933, false, true);
		addText(41285, "Next", sythescape, 0, 0xff9933, false, true);
	...
	public static void boltEnchanting(TextDrawingArea[] sythescape) {
		...
		addText(42756, "Magic 4", sythescape, 1, 0xff9933, true, true);
		addText(42757, "Magic 7", sythescape, 1, 0xff9933, true, true);
		addText(42758, "Magic 14", sythescape, 1, 0xff9933, true, true);
		addText(42759, "Magic 24", sythescape, 1, 0xff9933, true, true);
		addText(42760, "Magic 27", sythescape, 1, 0xff9933, true, true);
		addText(42761, "Magic 29", sythescape, 1, 0xff9933, true, true);
		addText(42762, "Magic 49", sythescape, 1, 0xff9933, true, true);
		addText(42763, "Magic 57", sythescape, 1, 0xff9933, true, true);
		addText(42764, "Magic 68", sythescape, 1, 0xff9933, true, true);
		addText(42765, "Magic 87", sythescape, 1, 0xff9933, true, true);
		addText(42766, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42767, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42768, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42769, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42770, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42771, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42772, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42773, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42774, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42775, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42776, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42777, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42778, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42779, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42780, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42781, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42782, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42783, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42784, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42785, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42786, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42787, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42788, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42789, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42790, "0/0", sythescape, 0, 0xFA0A0A, true, true);
		addText(42791, "0/0", sythescape, 0, 0xFA0A0A, true, true);
	...
	public static void reportAbuse(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(41750);
		addSprite(41751, 449);
		addHoverButton(41752, 17, 21, 21, "Close", 250, 41753, 3);
		addHoveredButton(41753, 18, 21, 21, 41754);
		addText(41755, "Report Abuse", sythescape, 2, 0xff9933, true, true);
		
		addText(41756, "This form is for reporting players who are breaking our rules.", sythescape, 1, 0xff9933, true, true);
		addText(41757, "Using it sends a snapshot of the last 60 seconds of activity to us.", sythescape, 1, 0xff9933, true, true);
		addText(41758, "Misusing this form will result with an infraction, or worse.", sythescape, 1, 0xDB0D0D, true, true);
		addText(41759, "Please enter the username of the offending player:", sythescape, 1, 0xff9933, true, true);
		
		addInputField(41750, 41760, 25, 0x332E24, 0x4D4636, 0x383631, 0x474540, "", 180, 23, false, false, "");
		
		addText(41761, "Please select the rule of which the offending player has broken.", sythescape, 1, 0xff9933, true, true);
		
		String[] rules = { 
			"Offensive language", "Item scamming", "Password scamming", "Bug abuse",
			"Sythescape staff impersonation", "Account sharing/trading", "Macroing", "Multiple logging in",
			"Advertising", "Real world trading", "Misuse of customer support", "Encouraging others to break rules",
		};
		
		for (int i = 0; i < rules.length; i ++) {
			addHoverText(41762 + i, (i + 1) + ") " + rules[i], "Select", sythescape, 0, 0xF7AA25, false, true, 250);
		}
	...
	public static void fireColor(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(49750);
		addSprite(49751, 400);
		addHoverButton(49752, 21, 21, 21, "Close", 250, 49753, 3);
		addHoveredButton(49753, 22, 21, 21, 49754);
		addText(49755, "Fire Color Changer", 0xff9933, true, true, -1, sythescape, 2);
		addText(49756, "By paying 10 credits you can change all fire colors.", 0xff9933, true, true, -1, sythescape, 0);
		addText(49757, "You will earn double cooking & firemaking exp for 30mins.", 0xff9933, true, true, -1, sythescape, 0);
		addText(49758, "Current Color: Orange", 0xff9933, true, true, -1, sythescape, 0);
		addText(49759, "Changed by: Daniel", 0xff9933, true, true, -1, sythescape, 0);
		addText(49760, "Daniel's Clan: Sythescape", 0xff9933, true, true, -1, sythescape, 0);
		addText(49761, "Change availability: 45minutes", 0xff9933, true, true, -1, sythescape, 0);
	...
	public static void starter(TextDrawingArea[] sythescape) {
		RSInterface Interface = addInterface(51750);
		
		addSprite(51751, 431);
		addText(51752, "Sythescape Account Setup", 0xff9933, true, true, 52, sythescape, 2);
		addHoverButton(51753, 17, 21, 21, "Close", 250, 51754, 3);
		addHoveredButton(51754, 18, 21, 21, 51755);
		addText(51756, "Select Your Game Mode:", 0xff9933, true, true, 52, sythescape, 1);
		addText(51757, "Starter Items:", 0xff9933, false, true, 52, sythescape, 1);
		itemDisplay(51758, 7, 15, 8, 3);
		addText(51759, "Mode Description:", 0xff9933, true, true, 52, sythescape, 2);
		addText(51760, "Line 1", 0xff9933, true, true, 52, sythescape, 0);
		addText(51761, "Line 2", 0xff9933, true, true, 52, sythescape, 0);
		addText(51762, "Line 3", 0xff9933, true, true, 52, sythescape, 0);
		...
		addHoverText(51766,"Normal", "Select Normal", sythescape, 0, 0xF7AA25, false, true, 250);
		addHoverText(51767,"Iron Man", "Select Iron Man", sythescape, 0, 0xF7AA25, false, true, 250);
		addHoverText(51768,"Ultimate Iron Man", "Select Ultimate Iron Man", sythescape, 0, 0xF7AA25, false, true, 250);
	...
	public static void inPvP(TextDrawingArea[] sythescape) {
		...
		addText(60253, "@or1@116 - 126", 0x000000, true, true, 52, sythescape, 0);
		addText(60254, "@or1@- - -", 0x000000, true, true, 52, sythescape, 0);
	...
	public static void godWars(TextDrawingArea[] sythescape) {
		int ID = 61750;
		RSInterface Interface = addInterface(ID);
		addText(ID + 1, "NPC Killcount", 0xEDE026, false, true, 52, sythescape, 0);
		String[] TEXTS = { "Armadyl", "Bandos", "Saradomin", "Zamorak" };
		for (int index = 0; index < 4; index++) {
			addText(ID + (2 + index), TEXTS[index] + " kills", 0xff9040, false, true, 52, sythescape, 0);
		}
		for (int index = 0; index < 4; index++) {
			addText(ID + (6 + index), "0", 0x54BFE3, false, true, 52, sythescape, 0);
		}
	...
	public static void inSafe(TextDrawingArea[] sythescape) {
	...
	public static void inTimer(TextDrawingArea[] sythescape) {
		RSInterface Interface = addInterface(60450);
		addSprite(60451, 424);
		addTooltipBox(60452, "You currently have a PvP timer.");
		addText(60453, "@whi@10", 0x000000, true, true, 52, sythescape, 3);
	...
	public static void spawnTab(TextDrawingArea[] sythescape) {
		RSInterface Interface = addInterface(61250);
		addSprite(61251, 82);
		addSprite(61252, 38);
		addText(61253, "SythescapePK Spawn Tab", sythescape, 0, 0xF7AA25, true, true);
		...
		addText(61257, "Item name:", sythescape, 0, 0xF7AA25, false, true);
		addText(61258, "Item amount:", sythescape, 0, 0xF7AA25, false, true);
		
		
		addText(61262, "Unnote:", sythescape, 0, 0xF7AA25, false, true);
		addText(61248, "Note:", sythescape, 0, 0xF7AA25, false, true);
		addText(61264, "Bank:", sythescape, 0, 0xF7AA25, false, true);
		...
		int y = 17;
		for (int i = 0; i < 100; i++) {
			addHoverText(61101 + i,"", "Select item", sythescape, 1, 0xF7AA25, false, false, 250);
	...
	public static void PKSkillTab(TextDrawingArea[] sythescape) {
		RSInterface Interface = addInterface(63700);
		addSprite(63701, 71);
		String[] levels = { "Attack", "Defence", "Strength", "Hitpoints", "Ranged", "Prayer", "Magic", "Bounty" };
		for (int i = 0; i < 8; i ++) {
			addText(63702 + i, "@or1@" + levels[i], 0x000000, false, true, 52, sythescape, 2);
		}
		for (int i = 0; i < 8; i ++) {
			addText(63720 + i, "@or2@99/99", 0x000000, false, true, 52, sythescape, 1);
		}
	...
	public static void loyaltyShop(TextDrawingArea[] tda) {
		...
		addText(id + 8, "Welcome to the Sythescape title shop.", tda, 0, 0xe6be78, false, true);
	...
	public static void tracker(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(54100);
		addSprite(54101, 371);
		addHoverButton(54102, 17, 21, 21, "Close", 250, 54103, 3);
		addHoveredButton(54103, 18, 21, 21, 54104);
		addText(54105, "Tracker", 0xff9933, true, true, -1, sythescape, 2);
		addText(54106, "Show's a list of tracked statistics.", 0xff9933, true, true, -1, sythescape, 0);
		tab.totalChildren(6);
		...
		int y = 0;
		for (int i = 0; i < 50; i++) {
			addHoverText(54111 + i, "", "", sythescape, 0, 0xcc8000, true, true, 300);
	 ...
	 * @param sythescape
	 */
	public static void bankSettings(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(32500);
		addSprite(32501, 368);
		addText(32502, "Sythescape Bank Settings", 0xff9933, true, true, -1, sythescape, 2);
		...
		addText(32509, "First item in tab", 0xff9933, true, true, -1, sythescape, 1);
		addText(32510, "Digit (1, 2, 3)", 0xff9933, true, true, -1, sythescape, 1);
		addText(32511, "Roman numeral (I, II, III)", 0xff9933, true, true, -1, sythescape, 1);
		addHoverText(32512, "Back to bank", "View", sythescape, 1, 0xcc8000, true, true, 100, 0xFFFFFF);
		tab.totalChildren(11);
	 ...
	 * @param sythescape
	 */
	public static void profileLeaderboards(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(47400);			
		addSprite(47401, 367);
		addHoverButton(47402, 17, 21, 21, "Close", 250, 47403, 3);
		addHoveredButton(47403, 18, 21, 21, 47404);
		addText(47405, "Profile Leaderboards", sythescape, 2, 0xF7AA25, true, true);
		...
		addText(47418, "Views", sythescape, 2, 0xF7AA25, true, true);
		addText(47419, "Likes", sythescape, 2, 0xF7AA25, true, true);
		addText(47420, "Dislikes", sythescape, 2, 0xF7AA25, true, true);
		addText(47421, "Ratio", sythescape, 2, 0xF7AA25, true, true);
		...
		int y = 0;
		for (int i = 0; i < 25; i++) {
			addHoverText(51551 + i, "Username", "View", sythescape, 0, 0xcc8000, true, true, 100, 0xFFFFFF);
			setBounds(51551 + i, 0, y, i, scrollInterface);
			y += 20;
		}
	}
	
	public static void settings(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(28400);
		
		addSprite(28401, 360);
		addSprite(28402, 38);
		addText(28403, "Settings", sythescape, 2, 0xF7AA25, true, true);
		addText(28404, "Customize your game play!", sythescape, 0, 0xF7AA25, true, true);
		...
		for (int i = 0; i < amount; i++) {		
			...
			addText(28450 + i, "", sythescape, 0, 0xF7AA25, false, true);
			setBounds(28450 + i, 45, y + 10, i + amount, scrollInterface);	
			y += 30;
		}
	}
	
	public static void staffTab(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(49700);			
		addSprite(49701, 360);
		addSprite(49702, 38);
		addText(49703, "Staff Tab", sythescape, 2, 0xF7AA25, true, true);
		addText(49704, "You have access to all commands!", sythescape, 0, 0xF7AA25, true, true);
		addText(49705, "</col>Rank: @red@<img=2> Owner", sythescape, 0, 0xF7AA25, true, true);
		addHoverText(49706, "> Back to Quest Tab <", "Go back", sythescape, 0, 0xF7AA25, true, true, 60);
	 ...
	 * @param sythescape
	 */
	public static void profileTab(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(51500);			
		addSprite(51501, 360);
		addSprite(51502, 38);
		addText(51503, "Player Profiler", sythescape, 2, 0xF7AA25, true, true);
		...
		addHoverText(51509, "Enable Privacy", "Enable", sythescape, 0, 0xF7AA25, false, true, 60);
		addHoverText(51510, "Disable Privacy", "Disable", sythescape, 0, 0xF7AA25, false, true, 60);
		addHoverButton(51511, 36, 150, 35, "View my profile", 0, 51512, 1);
		addHoveredButton(51512, 37, 150, 35, 51513);
		addText(51514, "My Profile", sythescape, 2, 0xF7AA25, true, true);
		addHoverButton(51515, 36, 150, 35, "View profile leaderboards", 0, 51516, 1);
		addHoveredButton(51516, 37, 150, 35, 51517);
		addText(51518, "Leaderboards", sythescape, 2, 0xF7AA25, true, true);
	 ...
	 * @param sythescape
	 */
	public static void myProfile(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(51600);	
		addSprite(51601, 359);
		addText(51602, "My Profile", sythescape, 2, 0xff981f, true, true);
		addHoverButton(51603, 17, 21, 21, "Close", 250, 51604, 3);
		addHoveredButton(51604, 18, 21, 21, 51605);
		addChar(51606, 700);
		addText(51607, "</col>Name: @gre@Daniel", sythescape, 1, 0xff981f, true, true);
		addText(51608, "</col>Rank: @cr2@@gre@  Owner", sythescape, 1, 0xff981f, true, true);
		addText(51609, "</col>Level: @gre@126", sythescape, 1, 0xff981f, true, true);
		for (int i = 0; i < 21; i++) {
		...
		int y = 0;
		for (int i = 0; i < 35; i++) {
			addHoverText(51681 + i, "" , "", sythescape, 0, 0xff981f, true, true, 160, 0xff981f);
	 ...
	 * @param sythescape
	 */
	public static void playerProfiler(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(51800);	
		addSprite(51801, 359);
		addText(51802, "Player Profiler", sythescape, 2, 0xff981f, true, true);
		addHoverButton(51803, 17, 21, 21, "Close", 250, 51804, 3);
		addHoveredButton(51804, 18, 21, 21, 51805);
		addOtherChar(51806, 700);
		addText(51807, "</col>Name: @gre@Daniel", sythescape, 1, 0xff981f, true, true);
		addText(51808, "</col>Rank: @cr2@@gre@  Owner", sythescape, 1, 0xff981f, true, true);
		addText(51809, "</col>Level: @gre@126", sythescape, 1, 0xff981f, true, true);
		for (int i = 0; i < 21; i++) {
		...
		int y = 0;
		for (int i = 0; i < 35; i++) {
			addHoverText(51881 + i, "" , "", sythescape, 0, 0xff981f, true, true, 160, 0xff981f);
	 ...
	 * @param sythescape
	 */
	public static void warriorGuild(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(51200);	
		addText(51202, "Warrior's Guild", sythescape, 2, 0xff981f, true, true);
		itemDisplay(51203, 30, 30, 4, 5);
		addText(51204, "Dropping:", sythescape, 0, 0xff981f, true, true);
		addText(51205, "Tokens Used:", sythescape, 0, 0xff981f, true, true);
		addText(51206, "Cyclops Killed:", sythescape, 0, 0xff981f, true, true);
		tab.totalChildren(5);
	 ...
	 * @param sythescape
	 */
	public static void prestige(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(51000);
		addSprite(51001, 301);
		addChar(51002, 560);
		addHoverButton(51003, 17, 21, 21, "Close", 250, 51004, 3);
		addHoveredButton(51004, 18, 21, 21, 51005);
		addText(51006, "Prestige Panel", sythescape, 2, 0xff981f, false, true);
		addText(51007, "Daniel", sythescape, 1, 0xff981f, true, true);
		addText(51008, "Total Prestige(s): 0", sythescape, 1, 0xff981f, true, true);
		addText(51009, "Prestige Pnt(s): 0", sythescape, 1, 0xff981f, true, true);
		addText(51010, "Attack (0)", sythescape, 0, 0xff981f, true, true);
		addText(51011, "Strength (0)", sythescape, 0, 0xff981f, true, true);
		addText(51012, "Defence (0)", sythescape, 0, 0xff981f, true, true);
		addText(51013, "Ranged (0)", sythescape, 0, 0xff981f, true, true);
		addText(51014, "Prayer (0)", sythescape, 0, 0xff981f, true, true);
		addText(51015, "Magic (0)", sythescape, 0, 0xff981f, true, true);
		addText(51016, "RC (0)", sythescape, 0, 0xff981f, true, true);
		addText(51017, "Hitpoints (0)", sythescape, 0, 0xff981f, true, true);
		addText(51018, "Agility (0)", sythescape, 0, 0xff981f, true, true);
		addText(51019, "Herblore (0)", sythescape, 0, 0xff981f, true, true);
		addText(51020, "Thieving (0)", sythescape, 0, 0xff981f, true, true);
		addText(51021, "Crafting (0)", sythescape, 0, 0xff981f, true, true);
		addText(51022, "Fletching (0)", sythescape, 0, 0xff981f, true, true);
		addText(51023, "Slayer (0)", sythescape, 0, 0xff981f, true, true);
		addText(51024, "Mining (0)", sythescape, 0, 0xff981f, true, true);
		addText(51025, "Smithing (0)", sythescape, 0, 0xff981f, true, true);
		addText(51026, "Fishing (0)", sythescape, 0, 0xff981f, true, true);
		addText(51027, "Cooking (0)", sythescape, 0, 0xff981f, true, true);
		addText(51028, "Firemaking (0)", sythescape, 0, 0xff981f, true, true);
		addText(51029, "Woodcutting (0)", sythescape, 0, 0xff981f, true, true);
		addText(51030, "Farming (0)", sythescape, 0, 0xff981f, true, true);
		addText(51031, "Hunter (0)", sythescape, 0, 0xff981f, true, true);
	...
	public static void friendsTab(TextDrawingArea[] tda) {
		...
		addText(5070, "   Sythescape", tda, 0, 0xff9933, false, true);
	...
	public static void ignoreTab(TextDrawingArea[] tda) {
		...
		addText(5720, "   Sythescape", tda, 0, 0xff9933, false, true);
	 ...
	 * @param sythescape
	 */
	public static void expCounter(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(32800);
		addSprite(32801, 369);
		addHoverButton(32802, 17, 20, 20, "Close", 250, 32803, 3);
		addHoveredButton(32803, 18, 20, 20, 32804);
		addText(32805, "Exp Counter Settings", 0xff9933, true, true, -1, sythescape, 2);
		...
		addText(32809, "Normal", 0xff9933, false, true, -1, sythescape, 1);
		addText(32810, "Sideways", 0xff9933, false, true, -1, sythescape, 1);
		addText(32811, "Scrambled", 0xff9933, false, true, -1, sythescape, 1);
		tab.totalChildren(10);
	 ...
	 * @param sythescape
	 */
	public static void chatColor(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(37500);
		addSprite(37501, 261);
		addHoverButton(37502, 17, 21, 21, "Close", 250, 37503, 3);
		addHoveredButton(37503, 18, 21, 21, 37504);
		addText(37505, "Private Chat Color Changer", 0xff9933, true, true, -1, sythescape, 3);
		addText(37506, "Chosen color: ", 0xff9933, true, true, -1, sythescape, 1);
	...
	public static void itemDetails(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(59750);
		addSprite(59751, 456);
		addText(59752, "Item Details:", 0xff9933, true, true, -1, sythescape, 2);
		addText(59753, "</col>Item: @gre@Armadyl Godsword", 0xff9933, true, true, -1, sythescape, 0);
		addText(59754, "</col>General Price: @gre@85M", 0xff9933, true, true, -1, sythescape, 0);
		addText(59755, "</col>Tradeable: @gre@True", 0xff9933, true, true, -1, sythescape, 0);
		addText(59756, "</col>Noted: @gre@False", 0xff9933, true, true, -1, sythescape, 0);
		itemDisplay(59757, 30, 10, 5, 5, "Complain");
		addHoverText(59758, "-> Back <-" , "Go back to drop table", sythescape, 0, 0xff9933, true, true, 300);
		tab.totalChildren(8);
	 ...
	 * @param sythescape
	 */
	public static void dropTable(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(59800);
		addSprite(59801, 16);
		addHoverButton(59802, 454, 17, 17, "Close", 250, 59803, 3);
		addHoveredButton(59803, 455, 17, 17, 59804);
		addText(59805, "Monster Drop Guide", 0xff9933, true, true, -1, sythescape, 2);
		addText(59806, "Name:", 0xff9933, true, false, -1, sythescape, 0);
		addText(59807, "Level:", 0xff9933, true, false, -1, sythescape, 0);
		addText(59818, "", 0xff9933, true, false, -1, sythescape, 0);
		String[] table = { "Always", "Common", "Uncommon", "Rare", "Very Rare" };	
		for (int i = 0; i < table.length; i++) {
			addText(59808 + i, table[i], 0x000000, true, false, -1, sythescape, 0);
		}	
		...
		int y = 0;
		for (int i = 0; i < 50; i++) {
			addHoverText(59901 + i, "" , "", sythescape, 0, 0xCF4F0A, false, true, 300);
	 ...
	 * @param sythescape
	 */
	public static void mysteryBox(TextDrawingArea[] sythescape) {
		RSInterface rsinterface = addTabInterface(17000);
		addSprite(17001, 257);
		lotteryItem(17002);
		mysteryWonItem(17007);
		addText(17003, "Mystery Box ", sythescape, 2, 0xF7AA25, true, true);
		addHoverButton(17004, 258, 146, 37, "Bet credits", -1, 17005, 1);
		addHoveredButton(17005, 259, 146, 37, 9454);
		addText(17006, "</col>Credits: @gre@1,000", sythescape, 0, 0xF7AA25, true, true);
		addText(17015, "", sythescape, 0, 0xF7AA25, true, true);
		addHoverButton(47267, 21, 16, 16, "Close", -1, 47268, 1);
		addHoveredButton(47268, 22, 16, 16, 47269);
		addText(17008, "Mystery Box is a gambling minigame where you can bet 1 credit.", sythescape, 0, 0xF7AA25, true, true);
		addText(17009, "Rewards can vary from items worth @gre@1,000</col> - @gre@100,000,000</col> coins!", sythescape, 0, 0xF7AA25, true, true);
		addText(17010, "Good luck, may the odds be ever in your favor.", sythescape, 0, 0xF7AA25, true, true);
		addHoverText(17011, "Purchase more credits", "Purchase Sythescape credits", sythescape, 0, 0xF7AA25, false, true, 168);
		
		addText(17012, "Play", sythescape, 2, 0xF7AA25, true, true);
	 ...
	 * @param sythescape
	 */
	public static void genie(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(59500);
		addSprite(59501, 249);
		addText(59502, "Reset Statistics", 0xff9933, true, true, -1, sythescape, 2);
		...
		addText(59527, "Attack", 0xff9933, true, true, -1, sythescape, 0);
		addText(59528, "Strength ", 0xff9933, true, true, -1, sythescape, 0);
		addText(59529, "Defence", 0xff9933, true, true, -1, sythescape, 0);
		addText(59530, "Range", 0xff9933, true, true, -1, sythescape, 0);
		addText(59531, "Magic", 0xff9933, true, true, -1, sythescape, 0);
		addText(59532, "Prayer", 0xff9933, true, true, -1, sythescape, 0);
		addText(59533, "Hitpoints", 0xff9933, true, true, -1, sythescape, 0);
		addText(59534, "Please select the statistic you would like to reset.", 0xff9953, true, true, -1, sythescape, 0);
	 ...
	 * @param sythescape
	 */
	public static void barrows(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(59000);
		addTransparentSprite(59001, 248);
		addText(59002, "Barrows Brothers", 0xff9933, true, true, -1, sythescape, 2);
		addText(59003, "Ahrim the Blighted", 0xff9933, true, true, -1, sythescape, 1);
		addText(59004, "Dharok the Wretched", 0xff9933, true, true, -1, sythescape, 1);
		addText(59005, "Guthan the Infested", 0xff9933, true, true, -1, sythescape, 1);
		addText(59006, "Karil the Tainted", 0xff9933, true, true, -1, sythescape, 1);
		addText(59007, "Torag the Corrupted", 0xff9933, true, true, -1, sythescape, 1);
		addText(59008, "Verac the Defiled", 0xff9933, true, true, -1, sythescape, 1);
		tab.totalChildren(8);
	 ...
	 * @param sythescape
	 */
	public static void priceChecker(TextDrawingArea[] sythescape) {
		...
		addText(48511, "Price Checker", sythescape, 2, 0xFF981F, true, true);
		addText(48512, "Total price:", sythescape, 1, 0xFF981F, true, true);
		addText(48513, "115,424,152", sythescape, 0, 0xffffff, true, true);
		addText(48550, "", sythescape, 0, 0xffffff, true, true);
		addText(48551, "", sythescape, 0, 0xffffff, true, true);
		addText(48552, "", sythescape, 0, 0xffffff, true, true);
		addText(48553, "", sythescape, 0, 0xffffff, true, true);
		addText(48554, "", sythescape, 0, 0xffffff, true, true);
		addText(48555, "", sythescape, 0, 0xffffff, true, true);
		addText(48556, "", sythescape, 0, 0xffffff, true, true);
		addText(48557, "", sythescape, 0, 0xffffff, true, true);
		addText(48558, "", sythescape, 0, 0xffffff, true, true);
		addText(48559, "", sythescape, 0, 0xffffff, true, true);
		addText(48560, "", sythescape, 0, 0xffffff, true, true);
		addText(48561, "", sythescape, 0, 0xffffff, true, true);
		addText(48562, "", sythescape, 0, 0xffffff, true, true);
		addText(48563, "", sythescape, 0, 0xffffff, true, true);
		addText(48564, "", sythescape, 0, 0xffffff, true, true);
		addText(48565, "", sythescape, 0, 0xffffff, true, true);
		addText(48566, "", sythescape, 0, 0xffffff, true, true);
		addText(48567, "", sythescape, 0, 0xffffff, true, true);
		addText(48568, "", sythescape, 0, 0xffffff, true, true);
		addText(48569, "", sythescape, 0, 0xffffff, true, true);
		addText(48570, "", sythescape, 0, 0xffffff, true, true);
		addText(48571, "", sythescape, 0, 0xffffff, true, true);
		addText(48572, "", sythescape, 0, 0xffffff, true, true);
		addText(48573, "", sythescape, 0, 0xffffff, true, true);
		addText(48574, "", sythescape, 0, 0xffffff, true, true);
		addText(48575, "", sythescape, 0, 0xffffff, true, true);
		addText(48576, "", sythescape, 0, 0xffffff, true, true);
		addText(48577, "", sythescape, 0, 0xffffff, true, true);
	 ...
	 * @param sythescape
	 */
	public static void itemsOnDeath(TextDrawingArea[] sythescape) {
		...
		addText(17103, "Items Kept on Death", sythescape, 2, 0xff981f);
		addText(17104, "Items you keep on death if not skulled:", sythescape, 0, 0xff981f);
		addText(17105, "Items you loose on death if not skulled:", sythescape, 0, 0xff981f);
		addText(17106, "Information:", sythescape, 1, 0xff981f);
		addText(17107, "Max Items Kept on death:", sythescape, 1, 0xff981f);
		addText(17108, "~ 3 ~", sythescape, 1, 0xffcc33);
	 ...
	 * @param sythescape
	 */
	public static void creditsTab(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(52500);
		addSprite(52501, 38);
		addText(52502, "Sythescape Credits", 0xff9933, true, true, -1, sythescape, 2);
		addSprite(52503, 55);
		addText(52504, "Current credits:", 0xff9933, true, true, -1, sythescape, 0);
		addHoverText(52505, "Purchase more credits", "Purchase Sythescape credits", sythescape, 0, 0xF7AA25, true, true, 168);
		addSprite(52506, 56);
		tab.totalChildren(9);
		...
		for (int i = 0; i < 30; i++) {
			addHoverText(52531 + i, "", "Spend credit", sythescape, 0, 0xE3A724, true, true, 168, 0xFFFFFF);
	 ...
	 * @param sythescape
	 */
	public static void shopExchange(TextDrawingArea[] sythescape) {
		RSInterface tab = addInterface(53500);
		addSprite(53501, 43);
		addHoverButton(53502, 17, 21, 21, "Close", 250, 53503, 3);
		addHoveredButton(53503, 18, 21, 21, 53504);
		addText(53505, "Shops Exchange", 0xff9933, true, true, -1, sythescape, 2);
		addHoverButton(53506, 44, 45, 45, "Search", 0, 53507, 1);
		addHoveredButton(53507, 45, 45, 45, 53508);
		addText(53509, "Shop Owner:", 0xff9933, true, true, -1, sythescape, 2);
		addText(53510, "Shop Description:", 0xff9933, true, true, -1, sythescape, 2);
		tab.totalChildren(9);
		...
		int y = 0;
		for (int i = 0; i < 200; i++) {
			addHoverText(53516 + i, "Name: " + i, "View", sythescape, 0, 0xcc8000, false, true, 100, 0xFFFFFF);
			setBounds(53516 + i, 0, y, i, scrollInterface);
			y += 20;
		}
		y = 0;
		for (int i = 0; i < 200; i++) {
			addHoverText(53516 + 200 + i, "Motto: " + i, "View", sythescape, 0, 0xcc8000, false, true, 100, 0xFFFFFF);
	 ...
	 * @param sythescape
	 */
	private static void achievementsTab(TextDrawingArea[] sythescape) {
		RSInterface tab = addTabInterface(31000);
		addSprite(31001, 15);
		addText(31002, "Quests & Achievements", 0xff9040, false, true, 52, sythescape, 2);
		setChildren(5, tab);
		...
		int y = 5;
		for (int i = 0; i < 80; i++) {
			addHoverText(31006 + i, "", "View", sythescape, 0, 0xff0000, false, true, 300);
	 ...
	 * @param sythescape
	 */
	private static void shop(TextDrawingArea[] sythescape) {
		...
		addText(19679, "", 0xff981f, false, true, 52, sythescape, 1);
		addText(19680, "", 0xbf751d, false, true, 52, sythescape, 1);
		addButton(19681, 2, "Interfaces/Shop/SHOP", 0, 0, "", 1);
		addSprite(19687, 1, "Interfaces/Shop/ITEMBG");
		for (int i = 0; i < 36; i++) {
			addText(28000 + i, "-1,0", 0xffff00, false, false, 52, sythescape, 0);
		}
		...
		addText(19684, "Main Stock", 0xbf751d, false, true, 52, sythescape, 1);
		addText(19685, "Store Info", 0xff981f, false, true, 52, sythescape, 1);
	 ...
	 * @param sythescape
	 */
	public static void trainingTeleport(TextDrawingArea[] sythescape) {
		...
		addText(61023, "@or2@Teleportation Menu (@red@Training@or2@)", 0xff9933, true, true, -1, sythescape, 2);
		addText(61024, "@gre@Training", 0xff9933, true, true, -1, sythescape, 1);
		addText(61025, "Skilling", 0xff9933, true, true, -1, sythescape, 1);
		addText(61026, "Player Vs Player", 0xff9933, true, true, -1, sythescape, 1);
		addText(61027, "Player Vs Monster", 0xff9933, true, true, -1, sythescape, 1);
		addText(61028, "Minigame", 0xff9933, true, true, -1, sythescape, 1);
		addText(61029, "Other", 0xff9933, true, true, -1, sythescape, 1);
		addText(61030, "Teleport Information:", 0xff9933, true, true, -1, sythescape, 2);
		addText(61031, "Selected: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(61032, "Cost: @red@Free", 0xff9933, false, true, -1, sythescape, 0);
		addText(61033, "Requirement: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(61034, "Other: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addHoverButton(61035, 61, 123, 30, "Confirm Teleport", 0, 61036, 1);
		addHoveredButton(61036, 62, 123, 30, 61037);
		addText(61038, "Go!", 0xff9933, true, true, -1, sythescape, 3);
		tab.totalChildren(31);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(61051 + i, "", "Select", sythescape, 1, 0xff9633, true, true, 300);
	 ...
	 * @param sythescape
	 */
	public static void skillingTeleport(TextDrawingArea[] sythescape) {
		...
		addText(62023, "@or2@Teleportation Menu (@red@Skilling@or2@)", 0xff9933, true, true, -1, sythescape, 2);
		addText(62024, "Training", 0xff9933, true, true, -1, sythescape, 1);
		addText(62025, "@gre@Skilling", 0xff9933, true, true, -1, sythescape, 1);
		addText(62026, "Player Vs Player", 0xff9933, true, true, -1, sythescape, 1);
		addText(62027, "Player Vs Monster", 0xff9933, true, true, -1, sythescape, 1);
		addText(62028, "Minigame", 0xff9933, true, true, -1, sythescape, 1);
		addText(62029, "Other", 0xff9933, true, true, -1, sythescape, 1);
		addText(62030, "Teleport Information:", 0xff9933, true, true, -1, sythescape, 2);
		addText(62031, "Selected: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(62032, "Cost: @red@Free", 0xff9933, false, true, -1, sythescape, 0);
		addText(62033, "Requirement: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(62034, "Other: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addHoverButton(62035, 61, 123, 30, "Confirm Teleport", 0, 62036, 1);
		addHoveredButton(62036, 62, 123, 30, 62037);
		addText(62038, "Go!", 0xff9933, true, true, -1, sythescape, 3);
		tab.totalChildren(31);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(62051 + i, "", "Select", sythescape, 1, 0xff9633, true, true, 300);
	 ...
	 * @param sythescape
	 */
	public static void pvpTeleport(TextDrawingArea[] sythescape) {
		...
		addText(63023, "@or2@Teleportation Menu (@red@Player Vs Player@or2@)", 0xff9933, true, true, -1, sythescape, 2);
		addText(63024, "Training", 0xff9933, true, true, -1, sythescape, 1);
		addText(63025, "Skilling", 0xff9933, true, true, -1, sythescape, 1);
		addText(63026, "@gre@Player Vs Player", 0xff9933, true, true, -1, sythescape, 1);
		addText(63027, "Player Vs Monster", 0xff9933, true, true, -1, sythescape, 1);
		addText(63028, "Minigame", 0xff9933, true, true, -1, sythescape, 1);
		addText(63029, "Other", 0xff9933, true, true, -1, sythescape, 1);
		addText(63030, "Teleport Information:", 0xff9933, true, true, -1, sythescape, 2);
		addText(63031, "Selected: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(63032, "Cost: @red@Free", 0xff9933, false, true, -1, sythescape, 0);
		addText(63033, "Requirement: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(63034, "Other: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addHoverButton(63035, 61, 123, 30, "Confirm Teleport", 0, 63036, 1);
		addHoveredButton(63036, 62, 123, 30, 63037);
		addText(63038, "Go!", 0xff9933, true, true, -1, sythescape, 3);
		tab.totalChildren(31);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(63051 + i, "", "Select", sythescape, 1, 0xff9633, true, true, 300);
	 ...
	 * @param sythescape
	 */
	public static void bossTeleport(TextDrawingArea[] sythescape) {
		...
		addText(64023, "@or2@Teleportation Menu (@red@Player Vs Monster@or2@)", 0xff9933, true, true, -1, sythescape, 2);
		addText(64024, "Training", 0xff9933, true, true, -1, sythescape, 1);
		addText(64025, "Skilling", 0xff9933, true, true, -1, sythescape, 1);
		addText(64026, "Player Vs Player", 0xff9933, true, true, -1, sythescape, 1);
		addText(64027, "@gre@Player Vs Monster", 0xff9933, true, true, -1, sythescape, 1);
		addText(64028, "Minigame", 0xff9933, true, true, -1, sythescape, 1);
		addText(64029, "Other", 0xff9933, true, true, -1, sythescape, 1);
		addText(64030, "Teleport Information:", 0xff9933, true, true, -1, sythescape, 2);
		addText(64031, "Selected: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(64039, "Level: @red@0", 0xff9933, false, true, -1, sythescape, 0);
		addText(64032, "Cost: @red@Free", 0xff9933, false, true, -1, sythescape, 0);
		addText(64033, "Requirement: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(64034, "Other: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addHoverButton(64035, 61, 123, 30, "Confirm Teleport", 0, 64036, 1);
		addHoveredButton(64036, 62, 123, 30, 64037);
		addText(64038, "Go!", 0xff9933, true, true, -1, sythescape, 3);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(64051 + i, "", "Select", sythescape, 1, 0xff9633, true, true, 300);
	 ...
	 * @param sythescape
	 */
	public static void minigameTeleport(TextDrawingArea[] sythescape) {
		...
		addText(65023, "@or2@Teleportation Menu (@red@Minigame@or2@)", 0xff9933, true, true, -1, sythescape, 2);
		addText(65024, "Training", 0xff9933, true, true, -1, sythescape, 1);
		addText(65025, "Skilling", 0xff9933, true, true, -1, sythescape, 1);
		addText(65026, "Player Vs Player", 0xff9933, true, true, -1, sythescape, 1);
		addText(65027, "Player Vs Monster", 0xff9933, true, true, -1, sythescape, 1);
		addText(65028, "@gre@Minigame", 0xff9933, true, true, -1, sythescape, 1);
		addText(65029, "Other", 0xff9933, true, true, -1, sythescape, 1);
		addText(65030, "Teleport Information:", 0xff9933, true, true, -1, sythescape, 2);
		addText(65031, "Selected: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(65032, "Cost: @red@Free", 0xff9933, false, true, -1, sythescape, 0);
		addText(65033, "Requirement: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(65034, "Other: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addHoverButton(65035, 61, 123, 30, "Confirm Teleport", 0, 65036, 1);
		addHoveredButton(65036, 62, 123, 30, 65037);
		addText(65038, "Go!", 0xff9933, true, true, -1, sythescape, 3);
		tab.totalChildren(31);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(65051 + i, "", "Select", sythescape, 1, 0xff9633, true, true, 300);
	 ...
	 * @param sythescape
	 */
	public static void otherTeleport(TextDrawingArea[] sythescape) {
		...
		addText(61523, "@or2@Teleportation Menu (@red@Other@or2@)", 0xff9933, true, true, -1, sythescape, 2);
		addText(61524, "Training", 0xff9933, true, true, -1, sythescape, 1);
		addText(61525, "Skilling", 0xff9933, true, true, -1, sythescape, 1);
		addText(61526, "Player Vs Player", 0xff9933, true, true, -1, sythescape, 1);
		addText(61527, "Player Vs Monster", 0xff9933, true, true, -1, sythescape, 1);
		addText(61528, "Minigame", 0xff9933, true, true, -1, sythescape, 1);
		addText(61529, "@gre@Other", 0xff9933, true, true, -1, sythescape, 1);
		addText(61530, "Teleport Information:", 0xff9933, true, true, -1, sythescape, 2);
		addText(61531, "Selected: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(61532, "Cost: @red@Free", 0xff9933, false, true, -1, sythescape, 0);
		addText(61533, "Requirement: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addText(61534, "Other: @red@None", 0xff9933, false, true, -1, sythescape, 0);
		addHoverButton(61535, 61, 123, 30, "Confirm Teleport", 0, 61536, 1);
		addHoveredButton(61536, 62, 123, 30, 61537);
		addText(61538, "Go!", 0xff9933, true, true, -1, sythescape, 3);
		tab.totalChildren(31);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(61551 + i, "", "Select", sythescape, 1, 0xff9633, true, true, 300);
	...
	public static void optionTab(TextDrawingArea[] sythescape) {
		...
		addText(36016, "", sythescape, 1, 0xff9933, true, true);
		addText(36003, "Options Tab", sythescape, 1, 0xff9933, true, true);
		addText(36013, "Fixed", sythescape, 0, 0xff9933, true, true);
		addText(36014, "Resizable", sythescape, 0, 0xff9933, true, true);
		addText(36015, "Fullscreen", sythescape, 0, 0xff9933, true, true);
		addHoverText(36025, "Screen Options", "Screen Options", sythescape, 0, 0xff981f, true, true, 60);
	 ...
	 * @param sythescape
	 */
	public static void quickPrayers(TextDrawingArea[] sythescape) {
		int frame = 0;
	 ...
	 * @param sythescape
	 */
	public static void quickCurses(TextDrawingArea[] sythescape) {
		RSInterface tab = addTabInterface(17234);
		addTransparentSprite(17229, 444);
		addSprite(17201, 445);
		addText(17230, "Select your quick prayers:", sythescape, 0, 0xFF981F, false, true);
	 ...
	 * @param sythescape
	 */
	public static void equipmentScreen(TextDrawingArea[] sythescape) {
		...
		addText(15111, "", sythescape, 2, 0xe4a146, false, true);
		addText(15112, "Attack bonus", sythescape, 2, 0xFF981F, false, true);
		addText(15113, "Defence bonus", sythescape, 2, 0xFF981F, false, true);
		addText(15114, "Other bonuses", sythescape, 2, 0xFF981F, false, true);
		addText(15115, "Equipment Bonuses", sythescape, 2, 0xFF981F, false, true);
		addText(15116, "", sythescape, 0, 0xFF981F, true, true);
		addText(15117, "", sythescape, 0, 0xFF981F, true, true);
		addText(15118, "", sythescape, 0, 0xFF981F, true, true);
		for (int i = 1675; i <= 1684; i++) {
			textSize(i, sythescape, 1);
		}
		textSize(1686, sythescape, 1);
		textSize(1687, sythescape, 1);
		addChar(15125, 560);
	 ...
	 * @param sythescape
	 */
	public static void equipmentTab(TextDrawingArea[] sythescape) {
	 ...
	 * @param sythescape
	 */
	public static void clanChatTab(TextDrawingArea[] sythescape) {
		...
		addText(18135, "Join/Leave", sythescape, 0, 0xff9b00, true, true);
		addText(18136, "Clan Setup", sythescape, 0, 0xff9b00, true, true);
		addSprite(18137, 42);
		addText(18138, "Clan Chat", sythescape, 2, 0xff9b00, true, true);
		addText(18139, "Talking in: Not in chat", sythescape, 0, 0xff9b00, false, true);
		addText(18140, "Owner: None", sythescape, 0, 0xff9b00, false, true);
		
		addText(18252, "(0/100)", sythescape, 0, 0xff9b00, false, true);
		tab.totalChildren(14);
		...
		for (int i = 18144; i <= 18244; i++) {
			addText(i, "", sythescape, 0, 0xffffff, false, true);
		}
	 ...
	 * @param sythescape
	 */
	public static void clanChatSetup(TextDrawingArea[] sythescape) {
		...
		/* Clan Setup title */
		addText(43703, "Clan Setup", sythescape, 2, 0xFF981F, true, true);
		...
		for (int index = 0, id = 43704, y = 50; index < titles.length; index++, id += 3, y += 40) {
			...
			addText(id + 1, titles[index], sythescape, 0, 0xFF981F, true, true);
			addText(id + 2, defaults[index], sythescape, 1, 0xFFFFFF, true, true);
		...
		int id = 43720;
		int y = 74;
		addText(id, "Ranked Members", sythescape, 2, 0xFF981F, false, true);
		rsi.child(count++, id++, 202, y);
		addText(id, "Banned Members", sythescape, 2, 0xFF981F, false, true);
		...
		for (int index = id; index < id + lines; index++) {
			addText(index, "", sythescape, 1, 0xffffff, false, true);
		...
		/* Table info text */
		y = 47;
		addText(id, "You can manage both ranked and banned members here.", sythescape, 0, 0xFF981F, true, true);
		rsi.child(count++, id++, 337, y);
		addText(id, "Right click on a name to edit the member.", sythescape, 0, 0xFF981F, true, true);
	 ...
	 * @param sythescape
	 */
	public static void questTab(TextDrawingArea[] sythescape) {
		RSInterface tab = addTabInterface(29400);
		addSprite(29401, 82);
		addSprite(29402, 38);
		addText(29403, "Sythescape", sythescape, 2, 0xF7AA25, true, true);
		addHoverButton(29404, 84, 25, 25, "Achievement diary", -1, 29405, 1);
		addHoveredButton(29405, 85, 25, 25, 29406);
		addHoverButton(29410, 351, 15, 15, "Refresh", -1, 29411, 1);//114226
		addHoveredButton(29411, 352, 15, 15, 29412);				
		addHoverText(29413, "", "", sythescape, 0, 0x47B320, false, true, 50);
		tab.scrollMax = 0;
		tab.totalChildren(11);
		...
		for (int i = 0; i < amountOfLines; i++) {
			addHoverText(29501 + i, "", "", sythescape, 0, 0x47B320, false, true, 168);
