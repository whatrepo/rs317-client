...
public class LoginRenderer {
	...
	private String world[] = {
			"Sythescape Economy - Main world",
			"Sythescape PK - Coming soon",
	...
	public void processLoginScreen() {
		...
		if (client.loginScreenState == 0) {
			...
			if (client.clickMode3 == 1 && client.clickInRegion(centerX + 40, centerY + 7, centerX + 127, centerY + 17)) {// Account Recovery
				//client.launchURL("http://www.sythescape.com/forum/31-account-recovery/");
			}
		...
		if (client.loginScreenState == 1) {
			for (int index = 0, y = centerY - 19; index < worldsAmount.length; index++, y+= 20) {
				...
				if (client.clickMode3 == 1 && client.clickInRegion(centerX - 136, y, centerX + 204, y + 20)) {
					...
					//for the world select on sythescape, whydid we have that code ^^
	...
	private String[] announcements = {
			"Welcome to Sythescape!",
			"Sythescape is a community project",
			"Sythescape is maintained by the Technical Core team at www.sythe.org"
	...
	public void displayAnnounements() {
		...
		TextDrawingArea.drawAlphaGradient(0, 0, Client.frameWidth, 25, 0x354143, 0x263235, 205 - (int) (50 * Math.sin(announcementFade / 20.0)));
